...
export default function SignUp() {
  ...
  return (
    <div className="p-20 w-3/4 m-auto">
      ...
      <form className="flex flex-col gap-8 bg-white shadow-md rounded w-2/3 mx-auto my-2 p-4" onSubmit={submitClicked}>
        ...
        <div className="flex flex-col gap-2 w-1/2 m-auto">
          ...
          <Input className="text-left" innerRef={passwordConfirmRef} type="password" />
        </div>
        <Button className="w-1/3 m-auto" onClick={submitClicked}>تایید</Button>
      </form>
